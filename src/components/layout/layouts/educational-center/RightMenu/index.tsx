...
import Home from '@/components/icons/educational-center/Home';
import Courses from '@/components/icons/educational-center/Courses';
import PriceList from '@/components/icons/educational-center/PriceList';
import CoWorkers from '@/components/icons/educational-center/CoWorkers';
import Contact from '@/components/icons/educational-center/Contact';
